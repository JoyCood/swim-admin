...
define('PERM_FINANCE_READ',      8192);
define('PERM_FINANCE_EDIT',      16384);
define('PERM_FINANCE_EXPORT',    32768);
define('PERM_NOTES',             65536);
...
class ModelPermissionMain
{
	...
	const FINANCE_READ = PERM_FINANCE_READ;
	const FINANCE_EDIT = PERM_FINANCE_EDIT;
	const FINANCE_EXPORT = PERM_FINANCE_EXPORT;
	const NOTES = PERM_NOTES;
	...
	static protected $PermissionDict = array(
		...
		self::FINANCE_READ => '读取场馆打款',
		self::FINANCE_EDIT => '修改场馆打款',
		self::FINANCE_EXPORT => '导出场馆打款',
		self::NOTES => '订单备注',
	);
    ...
    static protected $Settings = array(
    	...
    	'orders' 	    => array(
    		'text' 	 => '订单管理',
    		'values' => array(self::READ, self::EDIT, self::CONFIRM, self::COMPLETE, self::REFUND, self::ADD, self::CLOCK, self::ALLOCATE_TEACHER, self::ALLOCATE_YONGGUAN, self::FINANCE_READ, self::FINANCE_EDIT, self::FINANCE_EXPORT, self::NOTES)
    	),
        'courpon' 	    => array(
            'text' 	 => '优惠券管理',
