...
class ModelPushMain 
{
    ...
    private function pushLinkNews($item, $title, $text, $startTime)
    {
        ...
        $broadcast->setPredefinedKeyValue("activity", "com.youngteam.funswimming.page.Activity_NoTitle_WebDetail_NewsMsg");
    ...
    private function pushOriginalNews($item, $title, $text, $startTime)
    {
        ...
        $broadcast->setPredefinedKeyValue("after_open", "go_activity");
        $broadcast->setPredefinedKeyValue("production_mode", $this->production_mode);
        $broadcast->setPredefinedKeyValue("activity", "com.youngteam.funswimming.page.Activity_SwimNews_Detail");
        ...
        $iosBroadcast->setCustomizedField("page", 'SWArticleOriginalViewController');
        $iosBroadcast->send();
    }
